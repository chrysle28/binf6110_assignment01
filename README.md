...
The quality of each assembly will be verified using Busco
...
```
Variant calling will be performed using Clair3
```
...
### 2.7 | Visualization
Visualization of the assembled genome will be done using [IGV (v2.19.7)](https://github.com/igvteam/igv). The following files will be inputted: reference genome FASTA (ASM694v2), assembly BAM, and read alignment BAM, and the GFF annotation file for the reference genome

Visualization of the assembly against the reference was done using Circos. Two different visualizations were done for comparison - one using the PAF file generated by Minimap2, and another using the coordinates file generated by Mummer

Visualization of variants through Circos
